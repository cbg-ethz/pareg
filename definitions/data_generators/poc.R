...
resample <- function(graph_list, tp, mineff = 1, maxeff = 2) {
...
pathways.weak.mt <- resample(pathways.weak, tp=0)
pathways.medium.mt <- resample(pathways.medium, tp=.5)
pathways.strong.mt <- resample(pathways.strong, tp=1)
